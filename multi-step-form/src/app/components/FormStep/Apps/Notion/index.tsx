...
export function Notion() {
  ...
  const app = apps.find(({ App }) => App === "Notion") || apps[0]
  ...
  return (
    <Fragment>
      <Form.Card>
        <Form.Header
          title={app.App}
          description="Notion is an all-in-one workspace app that enables users to create, plan, collaborate, and organize work and personal life through customizable notes, databases, kanban boards, wikis, and calendars, facilitating streamlined project management and productivity."
        ...
        <div className="flex flex-col gap-3 mt-5">
          ...
          <Image src={`/images/scenarios/notion.png`} className="w-full" unoptimized={true} width={500} height={100} alt="yogurt" style={{ objectFit: "cover" }} />
